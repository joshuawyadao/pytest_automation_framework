...
STRING_TEST_CASES = ("arith_str, expected_str, error_str", [
...
COMBO_TEST_CASES = ("arith_combo, expected_combo, error_combo",[
...
def test_division_int(calculator, div_int, expected_div_int, error_int, request):
    with error_int:
...
@pytest.mark.addition
def test_addition_str(calculator, arith_str, expected_str, error_str, request):
    with error_str:
...
@pytest.mark.str_input
@pytest.mark.subtraction
def test_subtraction_str(calculator, arith_str, expected_str, error_str, request):
    with error_str:
        x, y = request.getfixturevalue(arith_str)
...
@pytest.mark.str_input
@pytest.mark.multiplication
def test_multiplication_str(calculator, arith_str, expected_str, error_str, request):
    with error_str:
        x, y = request.getfixturevalue(arith_str)
...
@pytest.mark.str_input
@pytest.mark.division
def test_division_str(calculator, arith_str, expected_str, error_str, request):
    with error_str:
        x, y = request.getfixturevalue(arith_str)
...
@pytest.mark.addition
def test_addition_combo(calculator, arith_combo, expected_combo, error_combo, request):
    with error_combo:
...
@pytest.mark.combo_input
@pytest.mark.subtraction
def test_subtraction_combo(calculator, arith_combo, expected_combo, error_combo, request):
    with error_combo:
        x, y = request.getfixturevalue(arith_combo)
...
@pytest.mark.combo_input
@pytest.mark.multiplication
def test_multiplication_combo(calculator, arith_combo, expected_combo, error_combo, request):
    with error_combo:
        x, y = request.getfixturevalue(arith_combo)
...
@pytest.mark.combo_input
@pytest.mark.division
def test_division_combo(calculator, arith_combo, expected_combo, error_combo, request):
    with error_combo:
        x, y = request.getfixturevalue(arith_combo)
